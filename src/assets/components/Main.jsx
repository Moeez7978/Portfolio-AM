...
const Main = () => {
  return (
    <>
      <div className="container flex flex-col md:flex-row justify-between gap-6 md:gap-44 lg:gap-60 items-center my-auto p-8 border-b-2 border-slate-400 w-fit mx-auto">
