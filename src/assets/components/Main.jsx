      ...
      <div className="container flex flex-col md:flex-row justify-center gap-6 md:gap-44 lg:gap-60 items-center my-auto p-8 border-b-2 border-slate-400 md:max-w-7xl mx-auto">
        <div className="textcontent text-w flex flex-col gap-2 ">
          ...
          <motion.span 
             ...
             initial="hidden"
             animate="show"
          className='text-xl font-bold italic bg-gradient-to-r from-purple-900 via-slate-400 to-rose-300 bg-clip-text text-transparent tracking-tight'>Full Stack Developer & DevOps Engineer</motion.span>
          </div>
